...
HD_PWD='C:/Users/jscon/Desktop/sconetto/unb/ped/ula-final/ula-final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ULA_TL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ULA_TL.tcl
