...
HD_PWD='C:/Users/jscon/Desktop/sconetto/unb/ped/ula-final/ula-final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ULA_TL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ULA_TL.tcl -notrace
